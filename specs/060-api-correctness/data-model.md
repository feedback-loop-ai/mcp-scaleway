...
| 204 / empty | `undefined`; handlers documented as no-content return an acknowledgement object |
...
| Field | Rules |
|---|---|
| type | invalid_input (400), permission_denied (401/403), not_found (404), rate_limited (429), server_error (other) |
