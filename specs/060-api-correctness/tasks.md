...
- [x] Verify old paths and SDK transport mismatch with injected HTTP probes.
- [x] Fix relative paths, error mapping, authentication and pagination.
- [x] Migrate Autoscaling and remove retired DHCP operations.
