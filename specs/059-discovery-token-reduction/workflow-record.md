...
Feature: `059-discovery-token-reduction`. Review branch: `docs/spec-retrofit-final`. Recorded 2026-09-06.
...
The prerequisite scripts support `SPECIFY_FEATURE=059-discovery-token-reduction` independently of the checkout
